...
// Fix Hostinger email configuration with correct SMTP server
...
envContent = envContent.replace(/# Hostinger Email Configuration[\s\S]*?# EMAIL_SERVER_PORT=465 \(SSL\/TLS\)\n/g, '');
...
console.log('✅ .env file updated with correct Hostinger email configuration!');
console.log('📧 Email Server: smtp.hostinger.com:587');
